...
export const ItemCard = ({ product, quantity }: Props) => {
  ...
  return (
    <div className="flex items-center shadow rounded-lg w-full bg-gray-100 border-gray-100 ">
      ...
      <div className="flex p-4 items-center justify-center">
        ...
        <span className="text-2xl text-black font-medium mx-10">{quantity}</span>
        <button
